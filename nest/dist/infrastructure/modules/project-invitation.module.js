...
const public_project_invitation_controller_1 = require("../api/controllers/public-project-invitation.controller");
...
exports.ProjectInvitationModule = ProjectInvitationModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [
            ...
            public_project_invitation_controller_1.PublicProjectInvitationController
        ],
        providers: [
