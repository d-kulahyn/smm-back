...
class ContentPlanScheduledEvent implements ShouldBroadcastNow
{
    ...
    {
        return PermissionEnum::SCHEDULE_CONTENT;
    }
    ...
    {
        return ['scheduled_content' => new ContentPlanResource($this->contentPlan)];
    }

    public function broadcastAs(): string
    {
        return 'contentPlanScheduled';
    }
